<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><!--[if IE]><html xmlns="http://www.w3.org/1999/xhtml" class="ie"><![endif]--><!--[if !IE]><!--><html style="margin: 0;padding: 0;" xmlns="http://www.w3.org/1999/xhtml"><!--<![endif]--><head>
    ...
    <meta property="og:title" content="PQS Network" />
</head>
<!--[if mso]>
<body class="mso">
<![endif]-->
                    ...
                    <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;">
                        ...
                        <div class="column" style="text-align: left;color: #787778;font-size: 16px;line-height: 24px;font-family: Ubuntu,sans-serif;">
                            ...
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;" align="center">
                                <a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #80bf2e;" href="https://www.pqsnetwork.com"><img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top" style="border: 0;display: block;height: auto;width: 100%;max-width: 179px;" alt="PQS Network.com" width="179" src="https://www.pqsnetwork.com/wp-content/uploads/2020/06/cropped-plogo-1.png" /></a>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom:40px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    ...
                                    <p style="Margin-top: 40px;Margin-bottom: 0;">
                                        ...
                                        PQS Network<br>
                                        <a href="https://www.pqsnetwork.com">www.pqsnetwork.com</a><br>
                                        Phone - 01742849449
                                    </p>
                                </div>
                            </div>

              ...
              <div class="card-body">                  
                    ...
                    <div class="form-group">                    
                      <div class="row">
                        <div class="col-8">
                          ...
                          <input value="{{$data->rate_down}}" name="rate_down" type="text" class="form-control" placeholder="Enter down rate" required>
                        </div>
                        <div class="col-4">
                        <label>Unit</label>
                    ...
                    <div class="form-group">                    
                      <div class="row">
                        <div class="col-8">
                          <label>Up Rate</label>
                          <input value="{{$data->rate_up}}" name="rate_up" type="text" class="form-control" placeholder="Enter down rate" required>
                        </div>
                        <div class="col-4">
                        <label>Unit</label>

...
//------------------------------------------------------------------------------
    ...
    //UserService can set default properties for prompt in the following way
    //Lobibox.prompt.DEFAULT_OPTIONS = object;
    Lobibox.prompt = function (type, options) {
        return new LobiboxPrompt(type, options);
    };
    //UserService can set default properties for confirm in the following way
    //Lobibox.confirm.DEFAULT_OPTIONS = object;
    Lobibox.confirm = function (options) {
        return new LobiboxConfirm(options);
    };
    //UserService can set default properties for progress in the following way
    ...
    //UserService can set default properties for alert in the following way
    ...
    //UserService can set default properties for window in the following way
...
//------------------------------------------------------------------------------
    ...
    //UserService can set default options by this variable
    Lobibox.base = {};
...
//------------------------------------------------------------------------------
    ...
    //UserService can set default options to this variable
